package com.leaky.tokens.stubs.openai.web;
...
class CorrelationIdFilterTest {
    ...
    void usesIncomingHeader() throws Exception {
        ...
        request.addHeader(CorrelationIdFilter.HEADER_NAME, "corr-openai");
        ...
        assertThat(mdcValue.get()).isEqualTo("corr-openai");
        assertThat(response.getHeader(CorrelationIdFilter.HEADER_NAME)).isEqualTo("corr-openai");
