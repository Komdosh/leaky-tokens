...
public class TokenUsagePublishSimulation extends Simulation {
    ...
    private final io.gatling.javaapi.core.Body payload = StringBody(
        "{\"userId\":\"00000000-0000-0000-0000-000000000001\",\"provider\":\"openai\",\"tokens\":10,\"prompt\":\"hello\"}"
    );

    private final ScenarioBuilder scn = scenario("Token Usage Publish Baseline")
